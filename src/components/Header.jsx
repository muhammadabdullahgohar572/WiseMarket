...
export const Header = () => {
  ...
  return (
    <div className="flex ">
      <div
        className={`sm:hidden  fixed h-screen w-[100%] bg-[#ffffff] transition-all duration-1000 z-20 overflow-hidden absolute ${
          sidenav == true ? `-left 0` : `-left-full`
        }`}
      >
      ...
      <div className="px-5 md:px-8 w-full border-b border-[#e1e1e1]">
        <div className="mx-auto h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <i
              className="fa fa-bars text-xl xs:hidden cursor-pointer"
          ...
          <div className="hidden xs:inline-block lg:block">
          ...
          <div className="flex items-center">
            ...
            <Link to={"Account"}>
              ...
              <div>
                <Link to={"login"}>
                  <span className="cursor-pointer text-sm">sng up/</span>
                </Link>
